...
public class TwoHandSignClassifier extends AbstractSignClassifier{
	...
	setupClassifier(new SignedDB().getTwoHandData(language, hand, TwoHandTrainer.TW0_HAND_NUM_FEATURES), TwoHandTrainer.TW0_HAND_NUM_FEATURES, filename);
	...
	protected Instance createInstanceFromData(Map<String, Float> data){
		 Instance sampleInstance = new DenseInstance(TwoHandTrainer.TW0_HAND_NUM_FEATURES+1);
		 	for(int i=0; i<TwoHandTrainer.TW0_HAND_NUM_FEATURES;i++){
